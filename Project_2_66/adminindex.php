    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Admin Only</sup></div>
            </a>
...
$labels = [];
$data = [];
$sql4 = "SELECT grade_level, COUNT(*) AS count FROM tb_student WHERE grade_level IN ('ประกาศนียบัตรวิชาชีพ (ปวช.)','ประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.)','ปริญญาตรี') GROUP BY grade_level";
$result4 = $conn->query($sql4);
while ($row4 = $result4->fetch_assoc()) {
    $labels[] = $row4['grade_level'];
    $data[] = $row4['count'];
}
?>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Grade Level');
        ...
        var options = {
            'title': 'ภาพรวมนักเรียน / นักศึกษาทั้งหมด',
            'width': 500,
            'height': 400
        };
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">แผนภูมิแสดงจำนวนผู้สมัคร</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
